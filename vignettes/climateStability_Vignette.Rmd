...
precipDeviation <- deviationThroughTime(variableDirectory = "data/precipfiles/",
                                        timeSlicePeriod = 1000)
temperatureDeviation <- deviationThroughTime(variableDirectory = "data/tempfiles/",
                                             timeSlicePeriod = 1000)
```
...
unevenPrecipDeviation <- deviationThroughTime(variableDirectory = "data/precipfilesUneven/", 
                                              timeSlicePeriod = c(1000, 1000, 1000, 1000, 5000, 5000, 6000))
unevenTemperatureDeviation <- deviationThroughTime(variableDirectory = "data/tempfilesUneven/",
                                                   timeSlicePeriod = c(1000, 1000, 1000, 1000, 5000, 5000, 6000))
```
...
precipDeviation <- terra::rast(system.file("data/precipDeviation.asc", package = "climateStability"))
temperatureDeviation <- terra::rast(system.file("data/temperatureDeviation.asc", package = "climateStability"))
```
